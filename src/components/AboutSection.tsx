...
const pillars = [
  {
    icon: Camera,
    title: "كتالوج مصوّر قابل للتحديث",
    body: "صور كتالوج توضيحية من منتجاتنا المعروضة، مع وصف واضح وفئة محددة لتسهيل التصفح والاختيار قبل الاستفسار.",
  },
  {
    icon: ShieldCheck,
      ...
      <div className="container-page grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center">
        <div>
          ...
          <div className="mt-4 space-y-3 text-sm leading-relaxed text-ink-600">
            ...
            <p>
              الصور المعروضة صور كتالوج توضيحية من تشكيلتنا (12 سجلاً تجريبياً حالياً)، والبيانات قابلة للتحديث المستمر. للانتقال السريع استخدم
