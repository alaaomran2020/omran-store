...
export function BrandAdvantages() {
  const advantages = [
    { icon: Camera, title: "كتالوج مصوّر قابل للتحديث", desc: "صور كتالوج احترافية من منتجاتنا مع وصف واضح وكود لكل صنف لتسهيل الاستفسار." },
...
export function FAQPreview() {
  const faqs = [
    ...
    { q: "هل الصور عالية الجودة؟", a: "نعم — صور كتالوج المنتجات الرئيسية احترافية عالية الجودة (حتى دقة 1024×1024)، ويجري استكمال تحديث بقية الصور تباعًا. يمكن طلب صور إضافية لأي منتج عبر واتساب." },
  ];
