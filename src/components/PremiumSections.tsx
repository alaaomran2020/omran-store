...
export function BrandAdvantages() {
  const advantages = [
    { icon: Camera, title: "كتالوج مصوّر قابل للتحديث", desc: "صور توضيحية مؤقتة من منتجاتنا مع وصف واضح وكود لكل صنف لتسهيل الاستفسار." },
...
export function FAQPreview() {
  const faqs = [
    ...
    { q: "هل الصور حقيقية؟", a: "الصور المعروضة حالياً هي صور توضيحية مؤقتة وسجلات تجريبية (12 سجلاً) للمعاينة والاختبار، وسيتم تحديثها بالصور والبيانات الفعلية قريباً." },
  ];
