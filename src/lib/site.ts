...
export const siteConfig: SiteConfig = {
  ...
  tagline: "لعب أطفال - هدايا",
  description: "شركة عمران التجارية — لعب أطفال وهدايا. تعرّف على منتجاتنا وتواصل معنا عبر واتساب للاستفسار.",
  url: "https://omrantoys.store",
  logoUrl: "/logo.svg",
  footerDescription: "شركة عمران التجارية — لعب أطفال وهدايا. تصفّح المنتجات وتواصل معنا مباشرة لمعرفة التفاصيل والتوفر.",
  contact: {
    phone: "01555570269",
  ...
  operations: {
    ...
    announcementText: "شركة عمران التجارية — لعب أطفال - هدايا | استفسر عن أي منتج عبر واتساب",
    wholesaleNotice: "شركة عمران التجارية — لعب أطفال - هدايا | جميع المنتجات معروضة للاستفسار عبر واتساب، والأسعار والتوفر عند التواصل."
  },
  social: {
  ...
  seo: {
    metaTitle: "شركة عمران التجارية | لعب أطفال - هدايا",
    metaDescription: "شركة عمران التجارية — لعب أطفال وهدايا. تصفّح منتجات الأطفال والهدايا وتواصل معنا عبر واتساب لمعرفة السعر والتوفر في طنطا ومصر."
  },
  currency: "EGP",
  currencySymbol: "ج.م",
