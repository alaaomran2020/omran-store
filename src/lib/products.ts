 ...
 * 12 سجلاً تجريبياً وصوراً توضيحية مؤقتة (catalog-facebook)
 * الأسعار تُعرض كـ "استفسر عن السعر" — السعر النهائي عبر واتساب
 * البيانات تجريبية وصور توضيحية مؤقتة للمعاينة والاختبار.
 * يجب استبدال هذه البيانات بالبيانات الفعلية المؤكدة قبل الإطلاق التجاري.
 */
